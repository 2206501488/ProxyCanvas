...
| ChatGPT2API / OpenAI-compatible | `config/providers.json` 的 `providers.openai.apiKey`、`providers.openai.baseUrl`、`providers.openai.defaultModel` | 指向本地或远程 OpenAI-compatible 图片接口，默认本地 `http://127.0.0.1:8000/v1`。 |
